...
Extrude {0,0,thck} {Surface{1}; Layers{1};Recombine ;}
Extrude {0,0,thck} {Surface{2}; Layers{1};Recombine ;}
...
Extrude {0,0,thck} {Surface{6}; Layers{1};Recombine ;}
Extrude {0,0,thck} {Surface{7}; Layers{1};Recombine ;}
Extrude {0,0,thck} {Surface{8}; Layers{1};Recombine ;}
